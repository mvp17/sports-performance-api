...
class KeyWordEventsFile(SingletonModel):
    ...
    chart_perf_vars = models.TextField(blank=True, max_length=250, help_text="Performance variables separated by comma "
                                                                             "for showing their data to the chart data."
                                                                             " Use white spaces if you like."
                                       )
